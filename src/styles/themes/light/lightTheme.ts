...
export const lightColorsTheme: ITheme = {
  ...
  collapseBackground: 'linear-gradient(211.49deg, #806ccf -29.57%, #121430 121.11%)',
  ...
  layoutSiderBg: 'linear-gradient(261.31deg, #806ccf -29.57%, #121430 121.11%)',
